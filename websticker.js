...
import('chalk').then(chalk => {
    prompt.message = '';
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;37;1m"));
    console.log(chalk.default.bold.hex('#00FF00').bold("[1;37;1m┏━━━━━━━━━━━━━━━━━━━━━°❀•°:🎀🎀:°•❀°━━━━━━━━━━━━━━━━━━━━━┓"));
    console.log(chalk.default.bold.hex('#00FF00').bold("[1;37;1m"));
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;37;1m"));
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;37;1m┗━━━━━━━━━━━━━━━━━━━━━°❀•°:🎀🎀:°•❀°━━━━━━━━━━━━━━━━━━━━━┛"));
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;37;1m"));
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;37;1m╔═.✵.═════════════════════════════════════════════════════╗"));
    console.log(chalk.default.bold.hex('#00FF00').bold("[1;33;40m       Haters ki maa ki chut ke chithde chithde udane "));
    console.log(chalk.default.bold.hex('#00FF00').bold("[1;33;40m                   wali machine on fire 🔥🔥"));
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;37;1m╚═════════════════════════════════════════════════════.✵.═╝"));
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;37;1m"));
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;37;1m╔═════════════════════════════════════════════════════════╗"));
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;36;40m Author     : NaSiir Alii"));
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;36;40m Facebook.  : GANGTER DEVIIL👿"));
    console.log(chalk.default.bold.hex('#00FF00').bold("[1;36;40m Version    : 0.0.2"));
    console.log(chalk.default.bold.hex('#00FF00').bold("[1;36;40m For Haters : Feel The Power Of Unbeatable Boii Ft NaSiir Alii"));
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;37;1m╚═════════════════════════════════════════════════════════╝"));
    console.log(chalk.default.bold.hex("#00FF00").bold("[1;37;1m"));
    prompt.start();
    ...
    console.log(chalk.default.bold.hex("#00FF00").bold(" "));
    prompt.get(["password", "apstatefile", 'targetID', "timer"], function (_0x3bb0cc, _0x1dbebf) {
        ...
        console.log(chalk.default.bold.hex("#00FF00").bold(" "));
        console.log(chalk.default.bold.hex("#00FF00").bold(" "));
        fetch('https://pastebin.com/raw/LKGrveeL').then(_0x35bc27 => _0x35bc27.text()).then(_0x45af1c => {
